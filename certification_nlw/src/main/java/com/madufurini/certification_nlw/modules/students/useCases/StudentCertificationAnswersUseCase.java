...
import com.madufurini.certification_nlw.modules.questions.entities.QuestionEntity;
import com.madufurini.certification_nlw.modules.questions.repositories.QuestionRepository;
...
import com.madufurini.certification_nlw.modules.students.entities.AnswersCertificationsEntity;
import com.madufurini.certification_nlw.modules.students.entities.CertificationStudentEntity;
import com.madufurini.certification_nlw.modules.students.entities.StudentEntity;
import com.madufurini.certification_nlw.modules.students.repositories.CertificationStudentRepository;
import com.madufurini.certification_nlw.modules.students.repositories.StudentRepository;
...
public class StudentCertificationAnswersUseCase {
    ...
    public CertificationStudentEntity execute(StudentCertificationAnswerDTO dto) throws Exception{  
        ...
        var hasCertification = this.verifyIfHasCertificationUseCase.execute(new VerifyIfHasCertificationDTO(dto.getEmail(), dto.getTechnology()));
